...
const Home: React.FC<HomeProps> = ({ }) => {
    ...
    const [state, setState] = useState<MonopolyState>({
        board: [
            ...
            { type: 'railroad', name: 'Reading Railroad', price: 200, ownedByPlayerIndex: null, isMortgaged: false, cost: [25, 50, 100, 200] },
            ...
            { type: 'railroad', name: 'Pennsylvania Railroad', price: 200, ownedByPlayerIndex: null, isMortgaged: false, cost: [25, 50, 100, 200] },
            ...
            { type: 'railroad', name: 'B. & O. Railroad', price: 200, ownedByPlayerIndex: null, isMortgaged: false, cost: [25, 50, 100, 200] },
